...
const shared: TemplateField[] = [
  ...
  { key: "amount", label: "Amount", type: "currency", required: true, autoFillKey: "amount", position: "body" },
  { key: "currency", label: "Currency", type: "text", required: true, autoFillKey: "currency", position: "body" },
  { key: "paymentDate", label: "Payment date", type: "date", required: false, autoFillKey: "paymentDate", position: "body" },
  { key: "chain", label: "Network", type: "text", required: false, autoFillKey: "chain", position: "footer" },
  { key: "txHash", label: "Transaction hash", type: "text", required: false, autoFillKey: "txHash", position: "footer" },
