...
export default function TemplatesPage() {
  ...
  async function saveDraft(draft: TemplateDraft) {
    const result = draft.id ? await client.models.DocumentTemplate.update({ id: draft.id, name: draft.name, fields: draft.fields, updatedBy: userId }) : await client.models.DocumentTemplate.create({ workspaceId, name: draft.name, templateKey: draft.templateKey, documentType: draft.documentType, status: "draft", version: 1, isDefault: false, fields: draft.fields, createdBy: userId, updatedBy: userId });
